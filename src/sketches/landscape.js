export default function landscape(p) {
    ...
    p.setup = () => {
        ...
        for (let i = 0; i < 3; i++) { // initialize the clouds
            clouds[i] = new Cloud(num_clouds - i);
        }
    ...
    p.draw = () => { // this loops everything inside body
    ...
    function makeWaves() { // create the waves
    ...
    function Bubble(xstart, yspeed, size) { // class for bubble objects
    ...
    function Cloud(key) { // class for cloud objects
